...
public class App {
	...
	public static void main(String[] args) {
		...
		gerCias.adicionar(new CiaAerea("LA", "LATAM Linhas Aéreas"));
		gerCias.adicionar(new CiaAerea("GL", "Gol Linhas Aéreas S/A"));
		gerCias.adicionar(new CiaAerea("TP", "TAP Portugal"));
		gerCias.adicionar(new CiaAerea("AL", "Azul Linhas Aéreas"));

		GerenciadorAeronaves gerAvioes = new GerenciadorAeronaves();

		gerAvioes.adicionar(new Aeronave("759", "Boeing 737-300", 140));
		gerAvioes.adicionar(new Aeronave("738", "Boeing 737-400", 126));
		gerAvioes.adicionar(new Aeronave("395", "Airbus Industrie A380", 644));
		gerAvioes.adicionar(new Aeronave("774", "Boeing 767-400", 304));
...
//        gerAvioes.ordenarCodigo();
        ...
        CiaAerea latam = gerCias.buscarCodigo("LA");
        CiaAerea gol   = gerCias.buscarCodigo("GL");
        CiaAerea tap   = gerCias.buscarCodigo("TP");
        CiaAerea azul  = gerCias.buscarCodigo("AL");

        Aeronave b733 = gerAvioes.buscarCodigo("759");
        Aeronave b73g = gerAvioes.buscarCodigo("738");
        Aeronave a380 = gerAvioes.buscarCodigo("395");
